...
def get_btc_gru_predictions():
    model = load_model("ml_models/model_gru_btc.h5")
    data, close_prices, scaled_data, scaler = load_crypto_data("ml_models/btc_data.csv")
...
def get_btc_lstm_predictions():
    model = load_model("ml_models/model_lstm_btc.h5")
    data, close_prices, scaled_data, scaler = load_crypto_data("ml_models/btc_data.csv")
...
def get_sol_gru_predictions():
    model = load_model("ml_models/model_gru_sol.h5")
    data, close_prices, scaled_data, scaler = load_crypto_data("ml_models/sol_data.csv")
...
def get_sol_lstm_predictions():
    model = load_model("ml_models/model_lstm_sol.h5")
    data, close_prices, scaled_data, scaler = load_crypto_data("ml_models/sol_data.csv")
